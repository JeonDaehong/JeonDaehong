...
#### [1.2. PR: Backporting Removal of MiniClusterWithClientResource from Iceberg Flink Catalog (1.19, 1.20)](https://github.com/apache/iceberg/pull/13165)
- → (Merge Date: May 28, 2025)
