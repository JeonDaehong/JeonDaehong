...
<div style="display: flex; justify-content: space-between; gap: 10px;">
    <div style="text-align: center; display: inline-block; width: 30%;">
        <img src="https://github.com/user-attachments/assets/7bf40222-0ff5-4923-9b51-6f0926b5c2a6" alt="Engineer Information Processing Certificate" style="width: 50px; height: auto; margin-bottom: 5px;">
        <div style="font-weight: bold;">Engineer Information Processing Certificate</div>
        <div>Certificate Earned: 2023</div>
    </div>
    <div style="text-align: center; display: inline-block; width: 30%;">
        <img src="https://github.com/user-attachments/assets/b6f1faef-8eca-4b07-9e94-33d732017093" alt="Linux Master Level 2 Certificate" style="width: 50px; height: auto; margin-bottom: 5px;">
